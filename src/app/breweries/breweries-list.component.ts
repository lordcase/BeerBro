    ...
    <div>
      ...
      <div class="results">
        <div class="pagination">
          <div *ngIf="isFirst()" class="page_control back" (click)="handlePageDown()">&lt;</div>
...
export class BreweriesListComponent implements OnInit {
  ...
  constructor(private breweryService:BreweryService, private route:ActivatedRoute, private store: Store<any>) {
  ...
  refreshResults() {
    this.breweryService.getBreweries(this.current_page).subscribe(breweries=>{
